...
* $f(x)$ : función de distribución de probabilidad (variables discretgas), función de distribución de densidad (variables continuas)
...
## **Algunos modelos de probabilidad especiales**
