...
$$P(X<70) =\displaystyle\int_{-\infty}^{70} \dfrac{1}{\sqrt{1800 \pi }} \exp\Big\{-\frac{1}{1800 }(x-100)^{2}\Big\} \:dx$$
...
$$P(X>70) =\displaystyle\int_{70}^{\infty} \dfrac{1}{\sqrt{1800 \pi }} \exp\Big\{-\frac{1}{1800 }(x-100)^{2}\Big\} \:dx$$
...
Para el caso supongamos que $\mu = 120$ y $\sigma = 8$

```{r}
# round() , función para redondear a cero cifras decimanes
round(rnorm(100,120,8),0) 
